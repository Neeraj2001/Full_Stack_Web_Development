...
var lvsc = Math.random() * 100; // will show whole 2-digit numbers
lvsc = Math.floor(lvsc); // will show 0-99
// alert("Your love score is " + lvsc + "%");

// Add customized message depending on the love score obtained

if (lvsc > 70) {
    alert("Your love score is " + lvsc + "%." + " You love each other like Kanye loves Kanye");
}
...
if (lvsc <= 30) {
    alert("Your love score is " + lvsc + "%." + " You get together like oil and water");
}
